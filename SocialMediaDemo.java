...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        //... So we created YouTubeVideoAdapter, because we're geniuses.
        // Java doesn't allow mutability restriction, so the
        // adapter class doesn't have setters, because other things
        // might be referencing the YouTubeVideo that an adapter
        // is constructed with.
